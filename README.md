...
Здесь я собрал несколько примеров своих работ, расположив их в обратном хронологическом порядке. Каждый проект на этой странице снабжён кратким описанием и `линейкой` `тегов`, обозначающих его основные параметры и характеризующих контент. Ссылки ведут уже к более развернутой информации по каждому проекту и непосредственно к тетрадкам с кодом
