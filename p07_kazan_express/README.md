...
- *Например, метод поэтапной иерархической классификации, разработанный и реализованный с нуля, уменьшил время обучения всего до 4 минут, при потреблении памяти не более 3 Гб, хотя на "плоской" классификацией падало ядро даже в Google Colab*
